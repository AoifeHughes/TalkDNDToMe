...
from ..utils.file_utils import get_md5_hash
...
class CharacterManager:
    ...
    def update_character(self, character_name: str, update_type: str, update_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            try:
                self.chroma_client.delete_from_collection('character', where={"character_id": character_id})
            except:
                pass
