...
class ContentLoader:
        ...
        for file_path in files_to_process:
            try:
                ...
                content_classification = self._classify_content_type(
                    filename_no_ext, rel_path, content
                )
                ...
                doc = Document(
                    ...
                    metadata={
                        ...
                        "is_player_content": content_classification[
                            "is_player_content"
                        ],
                    },
                )
        ...
        try:
            ...
            for chunk in all_chunks:
                metadata = {
                    ...
                    "character_references": chunk.metadata.get(
                        "character_references", ""
                    ),
                    "location_references": chunk.metadata.get(
                        "location_references", ""
                    ),
                }
            ...
            for file_path in files_to_process:
                try:
                    self.chroma_client.delete_from_collection(
                        "campaign_reference", where={"source": file_path}
                    )
                except Exception:
                    pass
    ...
    def _classify_content_type(
        self, filename: str, rel_path: str, content: str
    ) -> Dict[str, Any]:
        ...
        if "character" in filename_lower:
            ...
            classification["subtype"] = (
                "npc" if "npc" in filename_lower else "character"
            )
